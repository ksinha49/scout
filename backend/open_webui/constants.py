...
|------------|----------------|--------------------|-----------------------------------------------------------------------------------------------------|
| 2025-03-06 | Bala           | CWE-73             | Added the INVALID_PATH contant to handle the invalid file paths                                     |
"""
...
class ERROR_MESSAGES(str, Enum):
    ...
    #CWE-73 Adeed to address the  External Control of File Name or Path
