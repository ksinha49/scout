...
|------------|----------------|--------------------|--------------------------------------------------------------------------------|
| 2025-04-01 | X1BA           | AMER-ENH3          | Addressed web search proxy issue                                               |
            ...
            for i in range(retries):
                try:
                    ...
                    if not self.session.verify:
                        kwargs["ssl"] = False
                    #AMER-ENH3  Modification for proxy setup    
                    async with session.get(
                        url, **(self.requests_kwargs | kwargs), proxy=AMERITAS_PROXY_URL
                    ) as response:
