...
async def generate_title(
    ...
    # MOD: CWE-1333 Modified the RE to address the Inefficient Regular Expression Complexity
    for message in messages:
        replace_details_tag(message)
     # CWE-1333 Modified the RE to address the Inefficient Regular Expression Complexity
...
def replace_details_tag(message):
    soup = BeautifulSoup(message["content"], 'html.parser')
    for details_tag in soup.find_all('details', attrs={'type': 'reasoning'}):
