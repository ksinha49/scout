...
- **🧠 Effortful Reasoning Control for OpenAI and Claude Models**: Introduced the reasoning_effort parameter in chat controls for supported models, enabling users to fine-tune how much cognitive effort a model dedicates to its responses, offering greater customization for complex queries and reasoning tasks.
