...
if (proxyUrl) {
  // Check if proxyUrl starts with 'http://' or 'https://'
  if (!/^https?:\/\//i.test(proxyUrl)) {
    // If not, prepend 'http://'
    proxyUrl = 'http://' + proxyUrl;
  }

  // Debug output to verify the proxy URL
  ...
  // Assign the custom fetch function to globalThis.fetch
  globalThis.fetch = customFetch;
} else {
  // No proxy set, use the default fetch
